...
public class SubscriberNotification {
    ...
    public static Consumer<String, Notification> createConsumer() {
        ...
        properties.setProperty(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "com.sk.i2i.evrencell.mq.model.NotificationDeserializer");

        Consumer<String, Notification> consumer = new KafkaConsumer<>(properties);
